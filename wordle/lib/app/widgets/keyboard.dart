      ...
      children: qwerty.map(
        (keyRow) => Row(
          ...
          children: keyRow.map((letter) {
            ...
            if (letter == 'DEL') return KeyboardButton.delete(onTap: onDeleteTapped);
            else if (letter == 'ENTER') return KeyboardButton.enter(onTap: onEnterTapped);
...
class KeyboardButton extends StatelessWidget {
  ...
  factory KeyboardButton.delete({required VoidCallback onTap}) => KeyboardButton(
    width: 56,
    onTap: onTap,
    backgroundColor: Colors.grey,
    letter: 'DEL'
