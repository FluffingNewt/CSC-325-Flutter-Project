...
import 'package:wordle/game/wordle.dart';
...
class Word extends Equatable {
  ...
  void addLetter(String val) {
    ...
    if (currentIndex != -1) letters[currentIndex] = Letter(val: val);
  }

  void removeLetter() {
    final recentLetterIndex = letters.lastIndexWhere((e) => e.val.isNotEmpty);

    if (recentLetterIndex != -1) letters[recentLetterIndex] = Letter.empty();
  }
